...
const shootAudio = new Audio("https://cryptogunner.online/wp-content/uploads/2023/05/shoot.mp3");
...
if (randomNumber >= 0 && randomNumber <= 33) {
  zombie.setAttribute("src","https://cryptogunner.online/wp-content/uploads/2023/05/z1.png");
...
if (randomNumber >= 34 && randomNumber <= 66) {
  zombie.setAttribute("src","https://cryptogunner.online/wp-content/uploads/2023/05/z2.png");
...
if (randomNumber >= 67 && randomNumber <= 100) {
  zombie.setAttribute("src","https://cryptogunner.online/wp-content/uploads/2023/05/z3.png");
